...
| 左指符号反転の比較動画 | `results/avatar-videos/finger-sign-20260923/side-by-side.mp4`。左画面=変更前、右画面=左指符号反転。数値と再生入力は`results/finger-sign-20260923/`。最新録画・改変済みHAOLAN/auto-custom。掌XY案は将来課題として未実装 |
