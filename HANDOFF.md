...
更新：2026-09-21。会話履歴なしで再開するための現在状態。過去の完了報告はここへ積み重ねない。
...
- 現在の依頼はREADMEと引き継ぎ文書の整理、その後のGitHubへのプッシュ。機能変更・新リリースは依頼されていない。
...
| 用途 | 場所 |
| --- | --- |
| 現在の検証アバター | `builds/player/avatars/haolan.tcap`。通常アバターにauto-customを適用。廃止済みデモ専用キーは使わない |
