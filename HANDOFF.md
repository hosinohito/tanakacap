...
| 左指絶対値化の最新動画 | `results/avatar-videos/finger-absolute-20260923/after.mp4`。比較は同階層`side-by-side.mp4`、左=旧符号反転、右=絶対値化。最新録画901フレーム約30秒、改変済みHAOLAN/auto-custom。入力と数値検証は`results/finger-absolute-video-20260923/` |
