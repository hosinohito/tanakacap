 ...
 public static class FaceExpressionChecks {
  public static void Run(){
   ...
   try {
    ...
    var normal=FacialExaggeration.Parse(new string[0]);
    ...
    var onlyLid=FacialExaggeration.Parse(new[]{"--eyelid-exaggeration",".7"});
    ...
    var maximum=new FacialExaggeration {Brow=1,Eye=1,Eyelid=1,Mouth=1};
    Require(maximum.BrowValue(0)==0&&maximum.MouthValue(0)==0&&maximum.LidValue(0)==0,"Neutral must not move under exaggeration");
    Require(maximum.BrowValue(1)==1&&maximum.LidValue(1)==1&&maximum.MouthValue(-1)==-1,"Exaggeration must respect shape range");
