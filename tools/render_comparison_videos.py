...
def run(output,comparison=None):
 ...
 if list(inputs) in (['brow-direct','brow-adaptive'], ['brow-1x','brow-2x'], ['fixed','adaptive'], ['pnp','size2d'], ['separate','body3d'], ['body3d','depth3d'], ['mouth-z','mouth-no-z'], ['CUDA-FP32','CUDA-FP16'],['custom-demo','existing','auto-custom']):
