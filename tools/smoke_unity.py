...
def main():
    ...
    parser.add_argument("--hand-trace",type=Path,help="Optional per-render numeric hand trace")
    ...
    if args.hand_trace:render_args += ["--hand-trace",str(args.hand_trace.resolve())]
